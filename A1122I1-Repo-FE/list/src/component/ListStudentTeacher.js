...
export const ListStudentTeacher = () => {
    ...
    const [teacherId, setTeacherId] = useState(11);
    const [teacher, setTeacher] = useState([]);
    useEffect(() => {
            const fetchApi = async () => {
                try {
                    const result = await StudentService.findAllWithTeacher(pageNumber, teacherId, searchKey)
            ...
            fetchApi()
        }, [pageNumber, searchKey, teacherId]
    )
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">
                                            <b>
                                            <img src= {require(`../picture/${teacher.avatar}`)}
